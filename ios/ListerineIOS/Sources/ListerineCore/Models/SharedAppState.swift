...
public enum ListerineSharedConstants {
    public static let watchAppGroupID = "group.de.malaber.listerine.watch"
    public static let sharedAppStateKey = "listerine.shared-app-state"
